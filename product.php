	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Administrar Productos</div>
			</div> <!-- /panel-heading -->
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	         ...
	         <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Costo: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
          ...
          <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Proveedor: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="proveeedor" placeholder="Proveedor" name="proveedor" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	     
	        ...
	        <div class="form-group">
	        	<label for="categoryName" class="col-sm-3 control-label">Nombre de Categoría: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createProductBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Grabar Cambios</button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			          ...
			          <div class="form-group">
			        	<label for="editRate" class="col-sm-3 control-label">Costo: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editCosto" placeholder="Costo" name="editCosto" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	     	        
			        ...
			        <div class="form-group">
			        	<label for="editRate" class="col-sm-3 control-label">Proveedor: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProveedor" placeholder="Proveedor" name="editProveedor" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->	
			        ...
			        <div class="modal-footer editProductFooter">
				        ...
				        <button type="submit" class="btn btn-success" id="editProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Grabar Cambios</button>
				      </div> <!-- /modal-footer -->				     
			        </form> <!-- /.form -->				     	
				    </div>    
				    <!-- /product info -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeProductModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Remover Producto</h4>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <p>Estas seguro que quieres remover el producto?</p>
      </div>
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Cerrar</button>
        <button type="button" class="btn btn-primary" id="removeProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Grabar Cambios</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
